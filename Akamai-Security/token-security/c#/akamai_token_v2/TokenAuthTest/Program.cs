...
namespace TokenAuthTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Token with both EndTime and Window: {0}{1}", test.GetToken_BothEndTimeAndWindow(), Environment.NewLine);
            ...
            Console.WriteLine("Token with both Url and Acl: {0}{1}", test.GetToken_BothAclAndUrl(), Environment.NewLine);
            Console.WriteLine("Token with neither Url nor Acl: {0}{1}", test.GetToken_NoUrlAndAcl(), Environment.NewLine);
            Console.WriteLine("Token with neither EndTime nor Window: {0}{1}", test.GetToken_NoEndTimeAndWindow(), Environment.NewLine);
